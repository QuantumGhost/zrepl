...
godep() {
    ...
    go build -o "$GOPATH/bin/stringer"      golang.org/x/tools/cmd/stringer
    go build -o "$GOPATH/bin/protoc-gen-go" github.com/golang/protobuf/protoc-gen-go
    go build -o "$GOPATH/bin/enumer"        github.com/alvaroloes/enumer
    go build -o "$GOPATH/bin/goimports"     golang.org/x/tools/cmd/goimports
